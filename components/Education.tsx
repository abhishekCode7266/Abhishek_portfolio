        ...
        <div className="space-y-8">
          {data.education.map((edu, idx) => (
            <motion.div 
              ...
              className="max-w-3xl mx-auto bg-slate-50 dark:bg-slate-800/80 rounded-3xl p-8 sm:p-10 shadow-sm dark:shadow-slate-950/50 border border-slate-100 dark:border-slate-700/80"
            >
              <div className="flex flex-col sm:flex-row gap-6 sm:gap-8 items-start">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-slate-800 dark:text-slate-100 mb-2">{edu.degree}</h3>
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-6 text-slate-500 dark:text-slate-400 text-sm flex-wrap">
                    <span className="flex items-center gap-2">
                      <Calendar size={16} className="text-indigo-500 dark:text-indigo-400" />
                      {edu.startDate} - {edu.endDate}
                    </span>
                    {edu.percentage && (
                      <span className="flex items-center gap-2 bg-indigo-50 dark:bg-indigo-950/60 text-indigo-700 dark:text-indigo-300 border border-indigo-100/50 dark:border-indigo-800/60 px-3 py-1 rounded-full font-medium">
